...
#'
#' @export
#' @format \code{\link{R6Class}} object, super class \code{\link{NamespaceStep}}, sub classes \code{\link{DataStep}}, \code{\link{ViewDataStep}}.
...
CrossTabStep <- R6::R6Class("CrossTabStep", inherit = NamespaceStep, public = list(initialize = function(json = NULL) {
    if (!is.null(json)) {
        self$initJson(json)
    } else {
        self$init()
