...
#' @field model object of class \code{\link{DocumentStepModel}}.
DocumentStep <- R6::R6Class("DocumentStep", inherit = RelationStep, public = list(model = NULL, 
    initialize = function(json = NULL) {
        ...
        super$init()
        self$model = DocumentStepModel$new()
    }, initJson = function(json) {
        super$initJson(json)
        self$model = createObjectFromJson(json$model)
    }, toTson = function() {
        m = super$toTson()
        m$kind = tson.scalar("DocumentStep")
