...
#'
#' @export
#' @format \code{\link{R6Class}} object, super class \code{\link{SourceOperator}}.
#' @field source of type String inherited from super class \code{\link{SourceOperator}}.
...
RSourceOperator <- R6::R6Class("RSourceOperator", inherit = SourceOperator, public = list(initialize = function(json = NULL) {
    if (!is.null(json)) {
        self$initJson(json)
    } else {
        self$init()
